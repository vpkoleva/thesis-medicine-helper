...
-- -----------------------------------------------------
-- Table `medicinehelper`.`PatientToMobileUsers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `medicinehelper`.`PatientToMobileUsers` (
  `mobileUser_ID` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `medicinehelper`.`PatientToShedule`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `medicinehelper`.`PatientToShedule` (
  `Users_ID` INT NOT NULL,
  `Schedule_ID` INT NOT NULL,
  `startAfter` DATE NULL,
  `startAfterType` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `medicinehelper`.`SchedulesUnited`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `medicinehelper`.`SchedulesUnited` (
  ...
  `Description` VARCHAR(45) NOT NULL,
  `frequencyValue` INT(11) NULL DEFAULT NULL,
  `frequencyTypes` INT(11) NOT NULL,
  ...
  INDEX `fk_SchedulesUnited_DurationTypes1_idx` (`frequencyTypes` ASC),
...
CREATE TABLE IF NOT EXISTS `medicinehelper`.`schedules` (
  ...
  `durationType` INT(11) NOT NULL,
  `durationValue` INT(11) NULL DEFAULT NULL,
  `Doctor_ID` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `medicinehelper`.`patienttoshedule` (
  ...
  `startAfter` DATE NULL DEFAULT NULL,
  `startAfterType` INT(11) NOT NULL,
  INDEX `fk_UserToShedule_Users1_idx` (`Users_ID` ASC),
  INDEX `fk_UserToShedule_Schedule1_idx` (`Schedule_ID` ASC),
  INDEX `fk_UserToShedule_durationTypes1_idx` (`startAfterType` ASC),
  CONSTRAINT `fk_UserToShedule_durationTypes1`
...
CREATE TABLE IF NOT EXISTS `medicinehelper`.`raitings` (
  ...
  `DoctorsByUser_ID` INT(11) NOT NULL,
  `mobileUser_ID` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `medicinehelper`.`roles` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  `Role Name` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE INDEX `ID_UNIQUE` (`ID` ASC))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `medicinehelper`.`schedulesunited` (
  ...
  `frequencyValue` INT(11) NULL DEFAULT NULL,
  `frequencyTypes` INT(11) NOT NULL,
  `Patients_ID` INT(11) NULL,
  `Doctors_ID` INT(11) NOT NULL,
  `Diagnoses_ID` INT(11) NULL,
  `startAfterValue` INT(11) NULL,
  `endAfterValue` INT(11) NULL,
  `endAfterType` INT(11) NULL,
  `startAfterType` INT(11) NULL,
  PRIMARY KEY (`ID`),
  UNIQUE INDEX `ID_UNIQUE` (`ID` ASC),
  INDEX `fk_SchedulesUnited_Patients1_idx` (`Patients_ID` ASC),
  INDEX `fk_SchedulesUnited_Doctors1_idx` (`Doctors_ID` ASC),
  INDEX `fk_SchedulesUnited_Diagnoses1_idx` (`Diagnoses_ID` ASC),
  INDEX `fk_SchedulesUnited_DurationTypes1_idx` (`frequencyTypes` ASC),
  INDEX `fk_schedulesunited_durationtypes1_idx` (`endAfterType` ASC),
  INDEX `fk_schedulesunited_durationtypes2_idx` (`startAfterType` ASC),
  ...
  CONSTRAINT `fk_SchedulesUnited_Doctors1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_SchedulesUnited_DurationTypes1`
  ...
  CONSTRAINT `fk_schedulesunited_durationtypes1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_schedulesunited_durationtypes2`
    FOREIGN KEY (`startAfterType`)
    REFERENCES `medicinehelper`.`durationtypes` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `medicinehelper`.`users` (
  ...
  `lastName` VARCHAR(45) NULL DEFAULT NULL,
  `Doctor_ID` INT(11) NULL DEFAULT NULL,
  `mobileUser_ID` INT(11) NULL DEFAULT NULL,
